...
@Getter
@Setter
public class CheckoutTransferOutput {
    ...
    Long sender_luuky_transaction_id;
    BigDecimal sender_luuky_transaction_amount;
    Long sender_luuky_transaction_receiver;
    Long sender_luuky_transaction_sender;
    Date sender_luuky_transaction_performed_time;
